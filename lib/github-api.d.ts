declare module 'github-api' {
  ...
  namespace GitHub {
    ...
    class Repository {
       ...
       * @param {number} prnumber - the PR you wish to fetch
       * @param {Requestable.callback} [cb] - will receive the PR from the API
       * @return {axios.AxiosPromise} - the promise for the http request
       */
      getPullRequest(prnumber: number, cb?: Requestable.callback): axios.AxiosPromise;

      /**
       * List the files of a specific pull request
       * @see https://developer.github.com/v3/pulls/#list-pull-requests-files
       * @param {number|string} prnumber - the PR you wish to fetch
       * @param {Requestable.callback} [cb] - will receive the list of files from the API
       * @return {axios.AxiosPromise} - the promise for the http request
       */
      listPullRequestFiles(prnumber: (number | string), cb?: Requestable.callback): axios.AxiosPromise;
      ...
      createPullRequest(options: {
        ...
        head: string;
        base: string;
      }, cb?: Requestable.callback): axios.AxiosPromise;

      /**
       * Update a pull request
       * @deprecated since version 2.4.0
       * @see https://developer.github.com/v3/pulls/#update-a-pull-request
       * @param {number|string} prnumber - the number of the pull request to update
       * @param {Object} options - the pull request description
       * @param {Requestable.callback} [cb] - will receive the pull request information
       * @return {axios.AxiosPromise} - the promise for the http request
       */
      updatePullRequst(prnumber: (number | string), options: Object, cb?: Requestable.callback): axios.AxiosPromise;
       ...
       * @return {axios.AxiosPromise} - the promise for the http request
       */
      updatePullRequest(prnumber: (number | string), options: Object, cb?: Requestable.callback): axios.AxiosPromise;
       ...
       * @return {axios.AxiosPromise} - the promise for the http request
       */
      mergePullRequest(prnumber: (number | string), options: Object, cb?: Requestable.callback): axios.AxiosPromise;
  ...
  class GitHub {
     ...
     * GitHub encapsulates the functionality to create various API wrapper objects.
     */
    constructor(auth?: GitHub.Requestable.auth, apiBase?: string);
     ...
     * @return {User}
     */
    getUser(user?: string): GitHub.User;
     ...
     * @return {Organization}
     */
    getOrganization(organization: string): GitHub.Organization;
     ...
     * @return {Team}
     */
    getTeam(teamId: string): GitHub.Team;
     ...
     * @return {Repository}
     */
    getRepo(user: string, repo: string): GitHub.Repository;
     ...
     * @return {Issue}
     */
    getIssues(user: string, repo: string): GitHub.Issue;
     ...
     * @return {Search}
     */
    search(query: string|any): GitHub.Search;
